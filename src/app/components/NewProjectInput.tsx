      ...
      <div className='relative'>
        <div className='flex gap-2'>
          ...
          <button
            ...
            className='h-12 px-2 md:px-4 bg-[#3B82F6] text-white rounded font-medium hover:bg-[#2563EB] disabled:bg-[#9CA3AF] disabled:cursor-not-allowed flex items-center gap-1 md:gap-2 flex-shrink-0'
          >
            <Search className='w-4 h-4' />
            <span className='hidden md:inline'>Fetch</span>
          </button>
        </div>
        {error && <div className='text-xs text-[#EF4444] mt-1 ml-1'>{error}</div>}
      </div>
    </div>
  )
}
